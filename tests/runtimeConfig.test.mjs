...
test('production environment accepts secure auth configuration without an operator model key', () => {
...
test('legacy model and commerce variables are ignored in free BYOK production', () => {
