...
test('only liveness, readiness, and auth lifecycle APIs stay public', () => {
  ...
  for (const path of ['/api/chat', '/api/model', '/api/memory/c1', '/api/translate', '/api/language-assist', '/api/content', '/api/status', '/api/billing/checkout', '/api/billing/paddle/webhook']) {
